...
ARG WIN_UPDATE_PROVISIONER_VERSION=0.10.0
...
ADD https://github.com/rgl/packer-provisioner-windows-update/releases/download/v0.10.0/packer-provisioner-windows-update_0.10.0_linux_amd64.tar.gz ./packer-provisioner-windows-update-linux.tgz
